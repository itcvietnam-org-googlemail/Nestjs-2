...
var ServerXhr = class ServerXhr {
	...
	async ɵloadImpl() {
		if (!this.xhrImpl) {
			...
			const { default: xhr } = await import("./xhr2-Ba-3QVi0.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
			this.xhrImpl = xhr;
		}
	}
	build() {
